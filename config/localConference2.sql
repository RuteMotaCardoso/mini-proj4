...
CREATE TABLE IF NOT EXISTS `localconference`.`conf_speaker` (
  ...
  INDEX `speaker_fk_idx` (`idSpeaker` ASC) ,
...
CREATE TABLE IF NOT EXISTS `localconference`.`conf_sponsor` (
  ...
  INDEX `sponsors_fk` (`idSponsor` ASC) ,
  CONSTRAINT `confs_fk`
    FOREIGN KEY (`idConference`)
    REFERENCES `localconference`.`conference` (`idConference`),
...
-- -----------------------------------------------------
-- Table `localconference`.`voluntario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `localconference`.`voluntario` (
...
-- -----------------------------------------------------
-- Table `localconference`.`conf_voluntario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `localconference`.`conf_voluntario` (
  `idConference` INT(11) NOT NULL,
  `idVoluntario` INT NOT NULL,
  PRIMARY KEY (`idConference`, `idVoluntario`),
  INDEX `fk_conf_voluntario_voluntario1_idx` (`idVoluntario` ASC) ,
  CONSTRAINT `fk_conf_voluntario_conference1`
    FOREIGN KEY (`idConference`)
    REFERENCES `localconference`.`conference` (`idConference`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_conf_voluntario_voluntario1`
