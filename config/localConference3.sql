...
CREATE TABLE IF NOT EXISTS `localconference`.`conf_membroComissao` (
  ...
  PRIMARY KEY (`idConference`, `idMembro`),
  INDEX `fk_conf_membroComissao_membroComissao1_idx` (`idMembro` ASC) ,
  INDEX `fk_conf_membroComissao_conference1_idx` (`idConference` ASC) ,
...
-- -----------------------------------------------------
-- Table `localconference`.`tipoTarefa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `localconference`.`tipoTarefa` (
  `idtipoTarefa` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `localconference`.`tarefa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `localconference`.`tarefa` (
  ...
  PRIMARY KEY (`idTarefa`, `idTipoTarefa`, `idVoluntario`),
  INDEX `fk_tarefa_tipoTarefa1_idx` (`idTipoTarefa` ASC) ,
  INDEX `fk_tarefa_voluntario1_idx` (`idVoluntario` ASC) ,
  CONSTRAINT `fk_tarefa_tipoTarefa1`
    FOREIGN KEY (`idTipoTarefa`)
    REFERENCES `localconference`.`tipoTarefa` (`idtipoTarefa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tarefa_voluntario1`
    FOREIGN KEY (`idVoluntario`)
    REFERENCES `localconference`.`voluntario` (`idVoluntario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
